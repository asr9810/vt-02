...
export default function LuxuryCoach() {
  ...
  const [mainImage, setMainImage] = useState("/ourFleet/Buses/coach/1.jpg");
  ...
  vehicleName: `Luxury Coach rentals in Delhi NCR`,
  introText: `If you're looking to travel long distances with a large group, and keep it comfortable, nothing beats a Luxury Coach. Vivek Travels offers chauffeur-driven Luxury Coaches in Delhi NCR for weddings, corporate events, educational tours, spiritual yatras, and group travel across some very long distances in India.`,
  rentalIntroText: `Luxury Coaches are designed to be comfortable while moving. Our Luxury Coaches have pushback seats, air-conditioning, large windows and plenty of legroom, so everyone travels at ease, even when travelling very long distances. Our Luxury Coaches have modern day décor, luggage space, and great suspension. You'll feel more like you're in a lounge on wheels, than a bus.`,
      ...
      <div className="w-full px-4 py-10 flex flex-col items-center">
        ...
        <div className="w-full max-w-[1228px] flex flex-col lg:flex-row gap-10">
          <div className="w-full lg:w-[738px] flex flex-col gap-[14px]">
            ...
            >
              <img
                src="/ourFleet/Buses/coach/1.jpg"
                alt="Main Car"
