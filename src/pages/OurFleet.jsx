      ...
      <div className="flex flex-col items-center px-4 py-12">
        ...
        <div className="w-full max-w-[1206px] mb-12 text-center">
          ...
          >
            ...
            well-maintained, and we put our sedans to good use on each
            trip.Every sedan comes with a transport provider, so you can just
            relax and enjoy your journey without worrying about if you are
            running late or simply relaxing and enjoying your surroundings. All
            of our sedans include comfortable interior seating, effortless
            travel, and reliable service to suit your scheduling needs without
            any worries along the way.View our options for a sedan and enjoy
            your journey with Vivek Travels.
          </p>
        </div>
...
{fleetData.map((car, index) => {
  const slug = car.title.toLowerCase().replace(/\s+/g, "-").replace(/[()]/g, "");

  return (
    <div
      key={index}
      className="bg-white p-[18px] rounded shadow-md flex flex-col cursor-pointer hover:shadow-lg transition"
