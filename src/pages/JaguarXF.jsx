...
If you are looking for a premium travel experience in the Delhi NCR region, look no further. Book a Jaguar XF with Vivek Travels for a chauffeur-driven travel experience that’s a class above the rest. Every trip includes a well-maintained, beautiful vehicle with an amiable, experienced chauffeur with one purpose - to make you completely comfortable. `,
  ...
  vehicleParagraph: `We have Jaguar XF vehicles that are maintained in like-new condition and ready to take your travel experience to the next level. Whether you're traveling to an important event or having a quiet drive across the city, we feel our responsibility is to make sure you travel in ultimate comfort - with an undeniable style.`,
};

export default function JaguarXF() {
      ...
      <div className="w-full px-4 py-10 flex flex-col items-center">
        ...
        <div className="w-full max-w-[1228px] flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-[460px]  h-[80%] border border-black bg-[#3D3E98] text-white rounded-[10px] px-6 py-8 flex flex-col gap-4">
                <CarForm carName="Jaguar XF" />
          </div>
        </div>
      </div>
      <VehicleDetailInfoSection {...JaguarXFConfig} />
      <WhyRideSection />
