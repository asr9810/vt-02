...
export default function MarutiSuzukiInvicto() {
  ...
  const [mainImage, setMainImage] = useState("/ourFleet/SUV-MUV/invicto/1.jpg");
      ...
      <div className="w-full px-4 py-10 flex flex-col items-center">
        ...
        <div className="w-full max-w-[1228px] flex flex-col lg:flex-row gap-10">
          <div className="w-full lg:w-[738px] flex flex-col gap-[14px]">
            ...
            >
              <img
                src="/ourFleet/SUV-MUV/invicto/1.jpg"
                alt="Main Car"
          ...
          <div className="w-full lg:w-[460px]  h-[80%] border border-black bg-[#3D3E98] text-white rounded-[10px] px-6 py-8 flex flex-col gap-4">
                <CarForm carName="Maruti Suzuki Invicto" />
          </div>
        </div>
      </div>
      <VehicleDetailInfoSection {...MarutiSuzukiInvictoConfig} />
      <WhyRideSection />
