          ...
          <div className="px-4 md:px-0 mt-12">
            ...
            <div className="flex flex-col md:flex-row gap-10">
              ...
              <div className="flex flex-col justify-center w-full md:w-[469px] gap-8">
                ...
                <div>
                  <h3
                    className="text-[#3D3E98] mb-2 text-lg md:text-[24px] font-bold"
                    style={{ fontFamily: "DM Sans" }}
                  >
                    Address
                  </h3>
                  <p
                    className="text-gray-700 text-sm md:text-base leading-[140%]"
                    style={{ fontFamily: "DM Sans" }}
                  >
                    SD Block, 22, Main Road, DDA Market, Block SD, Dakshini
                    <br />
