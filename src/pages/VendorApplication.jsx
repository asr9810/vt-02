...
export default function VendorApplication() {
  ...
  return (
    <div className="min-h-screen bg-white flex justify-center items-start py-10 px-4 ">
      {/* <div className="flex flex-col md:flex-row w-full max-w-[1293px] gap-[5px] border border-blue-300"> */}
      <div className="flex flex-col md:flex-row w-full  justify-center ">
        ...
        {/* Form Section */}
        <div
          className="w-full rounded-[10px] py-10  sm:px-6 flex flex-col bg-gray-50"
          ...
          >
            ...
            <div className="mt-4  w-full">
              <button
                type="submit"
                disabled={isLoading}
                className={`bg-[#3D3E98] text-white font-bold rounded-[6px] w-full py-3 sm:w-[60%] md:w-[50%] text-[16px] hover:bg-[#2D2E78] transition-colors flex justify-center ${
