...
Book Hyundai Aura with Vivek Travels to make your travel enjoyable, trustworthy, and comfortable. Contact us for more information or to make a reservation.`,
  ...
  vehicleParagraph: `Each Hyundai Aura on our team is squeaky clean, perfectly kept, and waiting for you to have a comfortable ride! Our professional and friendly driver team are familiar with the roads on their fingertips, letting you lay back and soak in the journey. Do not be stressed out by the short and long road trips; enjoy your ride and your journey with us; the road trip should be just as pleasant as your destination.`,
};

export default function HyundaiAura() {
  ...
  const [mainImage, setMainImage] = useState("/ourFleet/Sedan/aura/1.jpg");
