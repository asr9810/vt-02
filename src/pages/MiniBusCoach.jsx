...
export default function MiniBusCoach() {
  ...
  const [mainImage, setMainImage] = useState("/ourFleet/Buses/mb/1.jpg");
  ...
  vehicleName: `Mini Bus Coach rentals in Delhi NCR`,
  introText: `Do you have to move a larger group and want to avoid the headaches? Our Mini Bus Coach is a perfect solution to provide seamless group road travel. Vivek Travels offers chauffeur driven Mini Bus Coach rental service in Delhi NCR for corporate outings, school or college excursions, weddings, pilgrimage, and outstation tours anywhere in India.`,
  rentalIntroText: `The Mini Bus Coach's comfort includes push-back seats, spacious leg room, and a wide aisle, so everyone on the trip can travel in comfort no matter how long the journey. With large windows, air-conditioned comfort, and clean interiors it is hard not to relax and enjoy yourself.`,
  ...
  vehicleSpecs: [['Air conditioning', 'yes'], ['Mileage', '7 KMPL'], ['Seats', '26'], ['Engine', '2200 cc to 3455cc']],
  ...
  return (
    <>
      ...
      <div className="w-full lg:w-[460px]  h-[80%] border border-black bg-[#3D3E98] text-white rounded-[10px] px-6 py-8 flex flex-col gap-4">
            <CarForm carName="Mini Bus Coach" />
          </div>
        </div>
      </div>
