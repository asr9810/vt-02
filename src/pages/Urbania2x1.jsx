...
With the Urbania electrified 2x1 seating layout, all passengers enjoy more space, better legroom, and a more comfortable travel experience— perfect for families, friends, or small teams that are travelling together. The Urbania provides ample headroom, updated interiors, and a smooth suspension that can make long drives feel like a hassle-free enjoyable trip.`,
    ...
    rentalClosingParagraph: `With professional, courteous drivers, our Urbania 2x1 provides a safe, timely and comfortable experience every time.`,
      ...
      <div className="w-full px-4 py-10 flex flex-col items-center">
        ...
        <div className="w-full max-w-[1228px] flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-[460px]  h-[80%] border border-black bg-[#3D3E98] text-white rounded-[10px] px-6 py-8 flex flex-col gap-4">
            <CarForm carName="Urbania 15 Seaters" />
          </div>
        </div>
      </div>
