...
export default function TataNexon() {
  ...
  vehicleSpecs: [['Air conditioning', 'Yes'], ['Motor Power', '110 kW'], ['Seats', '4 passengers+ driver'], ['Batter Capacity', '46.04 kWh']],
        ...
        <div className="w-full max-w-[1228px] flex flex-col lg:flex-row gap-10">
          <div className="w-full lg:w-[738px] flex flex-col gap-[14px]">
            ...
            <div className="flex items-center justify-between w-full">
              ...
              >
                {["/ourFleet/EV/nexon/1.jpg", "/ourFleet/EV/nexon/2.jpg", "/ourFleet/EV/nexon/3.jpg"].map((img, idx) => (
                  <img
                    key={idx}
                    src={img}
                    alt={`Car ${idx}`}
